...
## 依赖
* OpenCV
* [OpenVINO](https://flowus.cn/7a2a3341-74a1-4db9-bced-99fe5d05ab75)/[TensorRT-cuda](https://flowus.cn/e98af178-de0b-4546-808d-a6f1ff199d62)/[NCNN](https://flowus.cn/664f6bee-8ea9-4d54-8a78-e2c0bf38ee9f)/OnnxRunetime连接为简单部署文档
* fmt
* ceres
* Eigen3
* Sophus
...
│   ├── opt-1208-001.bin
│   ├── opt-1208-001.engine
│   ├── opt_1208_001.ncnn.bin
│   ├── opt_1208_001.ncnn.param
│   ├── opt_1208_001_ncnn.py
│   ├── opt-1208-001.onnx
│   ├── opt-1208-001.param
│   ├── opt_1208_001.pnnx.bin
│   ├── opt_1208_001.pnnx.onnx
│   ├── opt_1208_001.pnnx.param
│   ├── opt_1208_001_pnnx.py
│   ├── opt-1208-001.pnnxsim.onnx
│   ├── reborn_number_classifier.onnx
│   ├── yolox_rune_3.6m.bin
...
* 采用ekf与esekf的融合，同时针对角度的观测维度做了特殊处理，拥有整车模型和单装甲板模型，预测与击打更加鲁棒
* 