...
public:
    ...
    static Ptr create(
        ...
        return std::make_unique<VeryAimerMpc>(config, trajectory_compensator);
    }
    void reset();
    ...
    GimbalCmd veryAim(Target target, double bullet_speed, const AutoAimFsm& auto_aim_fsm) override;
