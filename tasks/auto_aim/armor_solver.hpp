...
public:
    ...
    enum ArmorSloveState { TRACKING_ARMOR = 0, TRACKING_CENTER = 1 };
    using StateCallback = std::function<StateResult(const ArmorSloveState)>;
    ArmorSolver() = default;
    ...
    ArmorSloveState armor_slover_state_ = TRACKING_ARMOR;
