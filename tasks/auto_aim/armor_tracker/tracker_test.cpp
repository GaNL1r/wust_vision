...
//         target_ =
//             Target(a, target_config_, 0.2765, 3, p0, armors.T_camera_to_odom, armors.camera_info);
//     } else if (a.number == armor::ArmorNumber::BASE) {
//         p0.diagonal() << 1, 64, 1, 64, 1, 64, 0.4, 100, 1e-4, 0, 0;
//         target_ =
//             Target(a, target_config_, 0.3205, 3, p0, armors.T_camera_to_odom, armors.camera_info);
//     } else {
//         p0.diagonal() << 1, 64, 1, 64, 1, 64, 0.4, 100, 1, 1, 1;
//         target_ =
//             Target(a, target_config_, 0.2, 4, p0, armors.T_camera_to_odom, armors.camera_info);
//     }
...
//             continue;
//         }
//         if (target_.update(std::make_pair(id, armor), armors.T_camera_to_odom, armors.camera_info))
//         {
//             found_count++;
//         }
//     }
