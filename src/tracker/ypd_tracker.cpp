...
double YpdTracker::orientationToYaw(const tf::Quaternion& q) noexcept {
...
Eigen::Vector3d YpdTracker::getArmorPositionFromState(const Eigen::VectorXd& x) noexcept {
