...
#include "detect/armor_detect/armor_detector_openvino.hpp"
...
std::vector<Light> ArmorDetectOpenVino::findLights(
...
bool ArmorDetectOpenVino::isArmor(const Light& light_1, const Light& light_2) noexcept {
