...
#include "detect/armor_detect/armor_detector_trt.hpp"
...
bool ArmorDetectTrt::isArmor(const Light& light_1, const Light& light_2) noexcept {
...
std::vector<Light> ArmorDetectTrt::findLights(
